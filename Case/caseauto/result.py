...
def result_data_case_auto(a, b, c, cardboard_req, paper_req, currency_req, kol, laminating=None):
    # материал
    ...
    nonproductwork = nonproductworkcase + nonproductworktray + nonproductworklaminating
