...
class ExpenceCubBoxInsert:
    ...
    def result(self, lis_siz):
        ...
        cardboard_info = ('крышка '+cardboard_lid['Информация'][6:])\
                         +('донышко '+cardboard_tray['Информация'][6:])\
                         +('вставка '+cardboard_insert['Информация'][6:])
        ...
        paper_tray = expence_pap(width_lt, length_lt, self.tray_hight, self.thickness_cb, lis_siz)
        ...
        paper_info = ('крышка ' + paper_lid['Информация'][19:]) \
                      + ('донышко ' + paper_tray['Информация'][19:]) \
                      + ('вставка ' + paper_insert['Информация'][19:])
        m2 = {
            'крышка': paper_lid['m2'],
            'дно': paper_tray['m2'],
