...
def result_data_casket_auto(a, b, c, cardboard_req, paper_req, currency_req, handle, kol, laminating=None):
    # материал
    ...
    production_cost = ((paper_count+cardboard_count+paper_count_laminate_lid+paper_count_laminate_tray)*data_calc.reject)+handle_count+magnets+data_calc.cut+work+nonproductwork
    # стоимости
