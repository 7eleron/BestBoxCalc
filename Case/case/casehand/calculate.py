from Case.case.case_cardboard import expence_case_cb
from Case.case.case_paper import expence_pap_case
...
class ExpenceCase:
    ...
    def result(self, lis_siz):
        ...
        paper_tray = expence_pap_rim(self.width, self.length, self.tray_hight, self.thickness_cb, lis_siz)
