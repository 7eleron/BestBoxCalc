...
def result_data_cdinsert_hand(a, b, tray_hight, lid_hight, insert_hight, cardboard_req, paper_req, currency_req, kol, laminating=None):
    # материал
    ...
    worklidinserttray = hand_work(a, b, tray_hight+lid_hight)*1.25
