from details.cubboxinsert.cbinsertauto.calculate import ExpenceCubBoxInsert
...
def result_data_cdinsert_auto(a, b, tray_hight, lid_hight, insert_hight, cardboard_req, paper_req, currency_req):
    # толщина картона
    ...
    work = machin_work_tray(paper['m2']['крышка']) + \
           machin_work_tray(paper['m2']['дно']) + \
           machin_work_tray(paper['m2']['вставка'])
    # стоимость штампа
    shtamp_res = resp(a, b, tray_hight, lid_hight, insert_hight)*1.66
