...
def result_data_casket_auto(a, b, c, cardboard_req, paper_req, cur_euro, handle):
    ...
    production_cost = ((paper_count+cardboard_count+handle_count+magnets)*data_calc.reject)+data_calc.cut+work+nonproductwork
    # стоимости
